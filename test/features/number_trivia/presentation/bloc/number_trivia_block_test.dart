...
void main() {
  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test(
      ...
      // we need to await for bloc to execute the event
    ...
    test('should emit [Error] when the input is invalid', () async {
      ...
      // Adding event later to ensure that the event is fired after we are expecting it, just to prevent and racing condition
      bloc.add(GetTriviaForConcreteNumber(tNumberString));
    });
  });
}
